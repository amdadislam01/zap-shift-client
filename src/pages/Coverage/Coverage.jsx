    ...
    <div className="w-full flex justify-center px-4 sm:px-6 lg:px-10 pt-28 pb-16 md:pb-24">
      <div className="w-[95%] sm:w-[90%] lg:w-[85%] xl:w-[80%] 2xl:w-[72%] bg-gray-50 rounded-2xl px-6 sm:px-10 py-14 md:py-20">
        ...
        <div className="w-full overflow-hidden rounded-xl">
          <MapContainer className="h-80" center={position} zoom={10} scrollWheelZoom={false}>
            <TileLayer
              attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
              url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
            />
            <Marker position={position}>
              <Popup>A Location For Your Product</Popup>
            </Marker>
          </MapContainer>
          {/* <img
            src="https://maps.googleapis.com/maps/api/staticmap?center=Bangladesh&zoom=6&size=1200x400&maptype=roadmap&key=YOUR_API_KEY"
